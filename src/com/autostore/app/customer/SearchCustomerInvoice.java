...
public class SearchCustomerInvoice {
    ...
    private ObservableList<CustomerInvoice> invoiceData = FXCollections.observableArrayList();
        ...
        try {
            ...
            if(!connection.isClosed()) {
                ...
                while(resultSet.next()) {
                    ...
                    CustomerInvoice invoiceModel = new CustomerInvoice();
    ...
    public ObservableList<CustomerInvoice> getCustomerData() {
        return invoiceData;
    }
}
